...
<div class='md:flex'>
    <div class='w-full p-2 mx-auto'>
        <div class='flex justify-between items-center pb-2'>
            ...
            <a href='https://github.com/pepegc/memento-mori' target='_blank'>
                <div class='flex items-center gap-1'>
                    <svg viewBox='' class='fill-gray-700 w-4 h-4'>
                    ...
                    <span class='text-xs'>pepegc/memento-mori</span>
                </div>
            </a>
        </div>
        <img
    ...
    <div class='flex flex-col p-2 mx-auto'>
        <div class=''>
            <p class='text-xs text-center mb-2'>52 weeks make a year</p>
        </div>
